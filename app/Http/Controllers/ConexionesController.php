...
class ConexionesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            "name" => ["required", "regex:/^[A-Za-z0-9[:space:]\s\S_-]+$/"],
            "rdbms_type" => ["required", "integer"],
            "sox" => ["required", "integer"],
            "hostname" => ["required", "regex:/^[A-Za-z0-9\s\S_-]+$/"],
            "ip_address" => ["required", "ip"],
            "port" => ["required", "integer"],
            "db_name" => ["required", "regex:/^[A-Za-z0-9\s\S_-]+$/"],
            "db_user" => ["required", "regex:/^[A-Za-z0-9\s\S_-]+$/"],
            "db_psw" => [
                "required", 
                "min:16", 
                "max:25"
    ...
    public function tipoConexion($data) {
        $tipoDB = $this->rdbmsType($data['rdbms_type'], $data['db_name']);
    ...
    public function rdbmsType($tipo, $db_name) {
        $dataDB = array();
        switch ($tipo) {
            case 1:
                $dataDB['tipo'] = 'oracle';
            ...
            case 2:
                $dataDB['tipo'] = 'sqlsrv';
                $dataDB['query'] = "SELECT TABLE_NAME FROM $db_name.INFORMATION_SCHEMA.TABLES";

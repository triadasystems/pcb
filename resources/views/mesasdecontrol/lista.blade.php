...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Mesas de Control</div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-right" style="margin-bottom:15px;">
                                ...
                                <button type="button" class="btn btn-success" id="altaMesasControl">Registrar Mesa de Control</button>
                            </div>
                        </div>
                        <div class="container table-responsive">
                            <table class="table table-bordered" id="tblmesascontrol">
                                <thead>
                                    <tr>
...
@push('scripts')
    <script>
        $(document).ready(function(){
            $("#altaMesasControl").click(function(){
                formAltaEditar();
            });
                ...
                swal({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'JSON',
                            url: '{{ route("editarstatusmesacontrol") }}',
                            async: false,
                            beforeSend: function(){
            ...
            $(document).on("click", "#guardarMesaControl", function(){
                guardarAltaEditar();
            });

            $(document).on("click", "#guardarEditarMesa", function(){
                guardarAltaEditar("editar");
            });

            var table = $('#tblmesascontrol').DataTable({
                language: {
